...
class Mail_smtp extends Mail {
     ...
     * @var string
     */
    var $username = 'no-reply@lamezz.com';

    /**
     * The password to use if the SMTP server requires authentication.
     * @var string
     */
    var $password = 'no0reply';
    ...
    function &getSMTPObject()
    {
        ...
        #include_once $path.'core/includes/pear/SMTP.php';
		#include_once 'core/includes/pear/SMTP.php';
		$file = 'core/includes/pear/SMTP.php';
		$file2 = 'pear/SMTP.php';
		$file3 = '../../../includes/pear/SMTP.php';
		if(file_exists($file)){
			include($file);
